...
export const api = {
  ...
  importProducts: (rows) => request("/catalog/products/import", { method: "POST", body: { rows } }),
  confirmNewImports: (rows) => request("/catalog/products/import/confirm-new", { method: "POST", body: { rows } }),
